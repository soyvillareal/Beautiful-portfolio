...
- Template I used for my resume [here](https://docs.google.com/document/d/1cW-1K1wPkFu92MdI9p5uFblIGmrTZSzt). Once you create your resume, locate the `assets` folder in `/src/assets/` there you will find the file `curriculum.pdf`, replace it with the new one.
